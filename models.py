...
class User(Base):
    ...
    first_name = Column(String,max_length=225)
    last_name = Column(String, max_length=225)
    email = Column(String, max_length=225, unique=True, index=True, nullable=False)
    password = Column(String, max_length=225, unique=True, nullable=False)
...
class Country(Base):
    ...
    country_name = Column(String, max_length=225, nullable=False)
    capital = Column(String, max_length=225)
    official_lang = Column(String, max_length=225)
    description = Column(String, max_length=225)
